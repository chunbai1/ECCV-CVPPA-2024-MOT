...
"""
cd datasets
mkdir -p mix_mot20_cvppa/annotations
cp MOT20_CVPPA/annotations/val_half.json mix_mot20_cvppa/annotations/val_half.json
cp MOT20_CVPPA/annotations/test.json mix_mot20_cvppa/annotations/test.json
cd mix_mot20_cvppa
ln -s ../MOT20_CVPPA/train mot20_train
cd ..
"""
