...
def make_parser():
    ...
    parser.add_argument(
        ...
        "--path", default="/data/ChaiJM/Competition/CVPPA-DMOT/Dataset/MOT_CVPPA24_DATA/valid/rgb/300", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default='/data/ChaiJM/Competition/CVPPA-DMOT/Code/ByteTrack-main/YOLOX_outputs/yolox_x_mix_det_cvppa/latest_ckpt.pth.tar', type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
